...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"add_select"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"add_select"] forState:UIControlStateHighlighted];
...
- (void)layoutSubviews
{
    ...
    self.plusBtn.frame = CGRectMake(kWindowW/2-WScale(22), -WScale(11), WScale(44), WScale(44));

...
@interface SHTakePhotoSelectView ()<UIGestureRecognizerDelegate>
...
@implementation SHTakePhotoSelectView
...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.popViewHeight = WScale(55)*3+SafeAreaBottomHeight+8;
...
-(void)setSelectArray:(NSArray *)selectArray
{
    ...
    self.popViewHeight = WScale(55)*selectArray.count+SafeAreaBottomHeight+8;
    ...
    for (int i = 0; i<selectArray.count; i++)
    {
        ...
        float height = i == selectArray.count-1?(WScale(55)*i+8):(WScale(55)*i);
        ...
        if (i>0) {
            ...
            {
                UILabel *lineLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, height-8, kWindowW, 8)];
                lineLabel.backgroundColor = UIColorFromRGB(0xf2f2f2);
